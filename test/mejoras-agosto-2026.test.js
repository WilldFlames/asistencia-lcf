...
test('calendario permite crear una prueba para todo el nivel o una sola sección',()=>{assert.match(front,/id="cta-alcance"/);assert.match(front,/Todo un nivel/);assert.match(cta,/WHERE s\.nivel=\$2/);assert.match(cta,/for\(const sid of secciones\)/);});
