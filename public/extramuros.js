...
function extLimpiarFormulario(){
  ["ext-nombre","ext-objeto","ext-mediacion","ext-lugar","ext-salida","ext-regreso","ext-observaciones","ext-exoneracion","ext-acompanante-nombre","ext-acompanante-telefono"].forEach(id=>document.getElementById(id).value="");
...
function extPayload(){return {nombre_actividad:document.getElementById("ext-nombre").value.trim(),objeto_actividad:document.getElementById("ext-objeto").value.trim(),mediacion_pedagogica:document.getElementById("ext-mediacion").value.trim(),lugar_actividad:document.getElementById("ext-lugar").value.trim(),fecha_actividad:document.getElementById("ext-fecha").value,hora_salida:document.getElementById("ext-salida").value,hora_regreso:document.getElementById("ext-regreso").value,observaciones:document.getElementById("ext-observaciones").value.trim(),descripcion_exoneracion:document.getElementById("ext-exoneracion").value.trim(),encargado_acompanante_nombre:document.getElementById("ext-acompanante-nombre").value.trim(),encargado_acompanante_telefono:document.getElementById("ext-acompanante-telefono").value.trim(),responsables:extResponsablesSeleccionados,estudiantes:extEstudiantesSeleccionados};}
...
function extPaginaAnexo2(d,e){
  ...
  const acompanante=a.encargado_acompanante_nombre
    ? `1. ${htmlSeguro(a.encargado_acompanante_nombre)}<br/>Teléfono: ${a.encargado_acompanante_telefono?htmlSeguro(a.encargado_acompanante_telefono):"____________________"}`
    : "1. __________________________________________<br/>Teléfono: ____________________";
  ...
  <table style="${extTablaEstilo()}"><tr><td style="${extTd()};width:50%;"><strong>Personal docente que participa en la actividad (nombre completo y número telefónico):</strong><div style="margin-top:4px;">${responsables}</div></td><td style="${extTd()};"><strong>Representantes legales del estudiantado que participan en la actividad (nombre completo y número telefónico):</strong><div style="margin-top:5px;">${acompanante}<br/><br/>2. __________________________________________<br/>Teléfono: ____________________</div></td></tr></table>
